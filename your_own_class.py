...
class Character():			#base parant class
	def __init__(self, race, health=100, attack=100, speed=100, armor=None, level=1):				#possible designs for the base character
	...
	def set_items(self, armor=None, level=1):			#set items method
		return("Your character needs to set a class before setting items.")

	def get_items(self, armor=None, level=1):			#get items method
		return("Your character currently has no items, pick a class and an assosiated held item.")

	def set_stats(self, armor=None, level=1):			#set stats method
		return("Base character's base stats don't change, pick a class before getting bonus stats.")

	def get_stats(self, armor=None, level=1):			#get stats method
		return("Base character's stats: \nHealth-100 \nAttack-100 \nSpeed-100 \nAttack Range-0")

	def characteristics(self, race, armor=None, level=None):			#characteristics method for which returns what the characters race and armor are
		self.__race = str(self.__race)
		self.__armor = str(self.__armor)
		if self.__armor == "None":							#checks if there is armor or not
	...
	def inventory(self, race=None, armor=None, level=None):			#inventory method
		self.__armor = str(self.__armor)
...
class Brawler(Character):			#child class
	...
	def set_items(self, race, armor=None, potion_type=None, level=1):			#set items method
		self.__potion_type = potion_type
		return "Item list compiled"

	def get_items(self, race, armor=None, potion_type=None, level=1):			#get items method
	...
	def get_stats(self, race, armor=None, potion_type=None, level=1):			#get stats method were it returns the stats from the set stats method
		self.set_stats(self)
	...
	def set_stats(self, race, armor=None, potion_type=None, level=1):			#set stats method
		self.__level = int(self.__level)
		#increase stats by the class multiplier
	...
	def characteristics(self, race, armor=None, potion_type=None, level=1):			#characteristics method for which returns what the characters race, armor and items are
		self.__race = race
		self.__class_item = "Small Sheild"
		self.__armor = armor
		self.__level = level
	...
	def inventory(self, race, armor=None, potion_type=None, level=1):			#inventory method
		self.__armor = str(armor)
		self.__potion_type = str(potion_type)
		if self.__potion_type == "None":							#checks if there is a held item or not
			if self.__armor == "None":							#checks if there is armor or not
...
class Archer(Character):			#child class
	...
	def set_items(self, race, armor=None, arrow_type=None, level=1):			#set items method
		self.__arrow_type = arrow_type
		return "Item list compiled"

	def get_items(self, race, armor=None, arrow_type=None, level=1):			#get items method
	...
	def get_stats(self, race, armor=None, arrow_type=None, level=1):			#get stats method were it returns the stats from the set stats method
		self.set_stats(self)
		self.__health = str(self.__health)
		self.__attack = str(self.__attack)
		self.__speed = str(self.__speed)
	...
	def set_stats(self, race, armor=None, arrow_type=None, level=1):			#set stats method
		self.__level = int(self.__level)
		#increase stats by the class multiplier
	...
	def characteristics(self, race, armor="No", arrow_type=None, level=1):			#characteristics method for which returns what the characters race, armor and items are
		self.__race = race
		self.__class_item = "Short Bow"
		self.__armor = armor
		self.__level = level
	...
	def inventory(self, race, armor=None, arrow_type=None, level=1):			#inventory method
		self.__armor = str(self.__armor)
		self.__arrow_type = arrow_type
		if self.__arrow_type == "None":							#checks if there is a held item or not
			if self.__armor == "None":							#checks if there is armor or not
...
class Rogue(Character):			#child class
	...
	def set_items(self, race, armor=None, knife_type=None, level=1):			#set items method
		self.__knife_type = knife_type
		return "Item list compiled"

	def get_items(self, race, armor=None, knife_type=None, level=1):			#get items method
	...
	def get_stats(self, race, armor=None, knife_type=None, level=1):			#get stats method were it returns the stats from the set stats method
		self.set_stats(self)
		self.__health = str(self.__health)
		self.__attack = str(self.__attack)
		self.__speed = str(self.__speed)
	...
	def set_stats(self, race, armor=None, knife_type=None, level=1):			#set stats method
		self.__level = int(self.__level)
		#increase stats by the class multiplier
		self.__health += (5 * self.__level)
	...
	def characteristics(self, race, armor=None, knife_type=None, level=1):			#characteristics method for which returns what the characters race, armor and items are
		self.__race = race
		self.__class_item = "Dagger"
		self.__armor = armor
		self.__level = level
	...
	def inventory(self, race, armor=None, knife_type=None, level=1):			#inventory method
		self.__armor = str(armor)
		self.__knife_type = str(knife_type)
		if self.__knife_type == "None":							#checks if there is a held item or not
			if self.__armor == "None":							#checks if there is armor or not
...
def main():				#main function where the user controls the character selection process.
